              ...
              <div className="card">
                <div className="card-body">
                  <div className="media align-items-center mb-4">
                    <img
                      className="mr-3"
                      src="https://w0.peakpx.com/wallpaper/951/679/HD-wallpaper-burak-deniz-cute-dashing-burak-handsome.jpg"
                      width={80}
                      height={80}
                      alt=""
                    />
                  ...
                  <p className="text-muted">
                    Hi, I'm Pikamy, has been the industry standard dummy text
